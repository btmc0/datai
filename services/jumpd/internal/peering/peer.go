...
import (
	...
	"github.com/sting8k/jump/services/jumpd/internal/apiclient"
...
// Peer manages the connection to a single remote jumpd instance.
//
...
// sseEvent is the wire format for jumpd SSE events.

// Package peering manages connections to remote jumpd instances (spokes).
//
// Each jumpd subscribes to its peers' GET /v1/events SSE streams and
...
// LauncherDef describes a single launchable adapter on a jumpd instance.

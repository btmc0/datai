// Package wsproxy provides a WebSocket reverse proxy from jumpd to jump-run
// session sockets. Browser connects to jumpd /ws/{session_id}, jumpd proxies
// bidirectionally to the jump-run Unix socket for that session.
//
...
func (p *Proxy) Handler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// Connect to jump-run's Unix socket.
		ctx := r.Context()

...
// Session is the in-memory model for a jump session. Fields are grouped
...
type Session struct {
	...
	// Peer identifies which jumpd instance owns this session.
	...
	// RunnerVersion is the version string of the jump runner binary that
	...
	// BinaryHash is the sha256 of the jump runner binary that launched

...
func TestResetStateIfHostnameChanged(t *testing.T) {
	...
	resetStateIfHostnameChanged(tsnetDir, "jump-hs")
	...
	if string(got) != "jump-hs\n" {
		t.Errorf("sentinel = %q, want %q", got, "jump-hs\n")
	}
}

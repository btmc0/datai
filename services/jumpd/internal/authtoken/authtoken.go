...
// characters). User-provided tokens (via JUMPD_TOKEN or file) must be
...
// 0600 permissions.
//
// On startup, the JUMPD_TOKEN environment variable can seed the token
...
//
// It reads JUMPD_TOKEN (unsetting it immediately to limit child process
...
// readEnv reads and validates JUMPD_TOKEN, then unsets it.

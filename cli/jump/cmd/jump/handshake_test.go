...
// the env-leak fix: after handshakeAck runs once, JUMP_HANDSHAKE_FD
...
// when the test binary is re-executed with JUMP_HANDSHAKE_TEST_CHILD=1,
...
func TestPipeHandshakeRoundTripViaSubprocess(t *testing.T) {
	const childIDEnv = "JUMP_HANDSHAKE_TEST_CHILD"

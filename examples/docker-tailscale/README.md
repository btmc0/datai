# jump in Docker with Tailscale

A containerized jump setup with Tailscale remote access. Access your
...
See the [Running in Docker](https://github.com/sting8k/jump/blob/dev/apps/website/src/content/docs/running-in-docker.md) guide for

...
// jumpd caps scrollback at 1 MiB × 2 files (~2 MiB max). xterm's default
 ...
 * from the jumpd broker. No WebSocket, no input, no resize messages: this
...
export function ReplayView({
  ...
  useEffect(() => {
    ...
    // Expose for e2e tests (matches TerminalView's window.__jumpTerm).
    ...
    <div class="replay-root">
      <div class="terminal-shell">
        ...
        {state.kind === 'not-found' && (
          <div class="terminal-loading">
            This session is no longer known to jumpd.
          </div>
        )}
        {state.kind === 'error' && (
          <div class="terminal-loading">

 ...
 *
 * The backend (jumpd) serves these files as raw JSON; all semantic
...
const settingsEntries = {
    ...
    fontFamily:       optStr("'Roboto Mono', 'Fira Code', monospace", 'Font family (CSS font-family value).'),
